...
QDEF(MP_QSTR_ACCEL_INT, (const byte*)"\xc1\xd2\x09" "ACCEL_INT")
QDEF(MP_QSTR_BATTERY, (const byte*)"\x88\x2b\x07" "BATTERY")
QDEF(MP_QSTR_BL_HI, (const byte*)"\xb5\x89\x05" "BL_HI")
QDEF(MP_QSTR_BL_LO, (const byte*)"\x37\x89\x05" "BL_LO")
QDEF(MP_QSTR_BL_MID, (const byte*)"\x94\xc3\x06" "BL_MID")
QDEF(MP_QSTR_BUTTON, (const byte*)"\xf3\xda\x06" "BUTTON")
QDEF(MP_QSTR_BUTTON_EN, (const byte*)"\xa7\xb3\x09" "BUTTON_EN")
QDEF(MP_QSTR_CHARGING, (const byte*)"\xfa\x53\x08" "CHARGING")
QDEF(MP_QSTR_DISP_CS, (const byte*)"\xa4\x20\x07" "DISP_CS")
QDEF(MP_QSTR_DISP_DC, (const byte*)"\x53\x20\x07" "DISP_DC")
QDEF(MP_QSTR_DISP_RST, (const byte*)"\x61\xf1\x08" "DISP_RST")
QDEF(MP_QSTR_HRS_TST, (const byte*)"\x20\xab\x07" "HRS_TST")
QDEF(MP_QSTR_I2C_SCL, (const byte*)"\x9e\x86\x07" "I2C_SCL")
QDEF(MP_QSTR_I2C_SDA, (const byte*)"\x74\x87\x07" "I2C_SDA")
QDEF(MP_QSTR_LCD_DETECT, (const byte*)"\x76\xde\x0a" "LCD_DETECT")
QDEF(MP_QSTR_MOTOR, (const byte*)"\xae\x11\x05" "MOTOR")
QDEF(MP_QSTR_NOR_CS, (const byte*)"\xb9\x1c\x06" "NOR_CS")
QDEF(MP_QSTR_P10, (const byte*)"\x14\x09\x03" "P10")
QDEF(MP_QSTR_P11, (const byte*)"\x15\x09\x03" "P11")
QDEF(MP_QSTR_P12, (const byte*)"\x16\x09\x03" "P12")
QDEF(MP_QSTR_P13, (const byte*)"\x17\x09\x03" "P13")
QDEF(MP_QSTR_P14, (const byte*)"\x10\x09\x03" "P14")
QDEF(MP_QSTR_P15, (const byte*)"\x11\x09\x03" "P15")
QDEF(MP_QSTR_P16, (const byte*)"\x12\x09\x03" "P16")
QDEF(MP_QSTR_P17, (const byte*)"\x13\x09\x03" "P17")
QDEF(MP_QSTR_P18, (const byte*)"\x1c\x09\x03" "P18")
QDEF(MP_QSTR_P19, (const byte*)"\x1d\x09\x03" "P19")
QDEF(MP_QSTR_P2, (const byte*)"\xa7\x74\x02" "P2")
QDEF(MP_QSTR_P22, (const byte*)"\xb5\x09\x03" "P22")
QDEF(MP_QSTR_P23, (const byte*)"\xb4\x09\x03" "P23")
QDEF(MP_QSTR_P24, (const byte*)"\xb3\x09\x03" "P24")
QDEF(MP_QSTR_P25, (const byte*)"\xb2\x09\x03" "P25")
QDEF(MP_QSTR_P26, (const byte*)"\xb1\x09\x03" "P26")
QDEF(MP_QSTR_P27, (const byte*)"\xb0\x09\x03" "P27")
QDEF(MP_QSTR_P28, (const byte*)"\xbf\x09\x03" "P28")
QDEF(MP_QSTR_P29, (const byte*)"\xbe\x09\x03" "P29")
QDEF(MP_QSTR_P3, (const byte*)"\xa6\x74\x02" "P3")
QDEF(MP_QSTR_P30, (const byte*)"\x56\x09\x03" "P30")
QDEF(MP_QSTR_P31, (const byte*)"\x57\x09\x03" "P31")
...
QDEF(MP_QSTR_TP_INT, (const byte*)"\xad\x55\x06" "TP_INT")
QDEF(MP_QSTR_TP_RST, (const byte*)"\x0b\x29\x06" "TP_RST")
QDEF(MP_QSTR_UART_RX, (const byte*)"\x82\x9c\x07" "UART_RX")
QDEF(MP_QSTR_UART_TX, (const byte*)"\x44\x9d\x07" "UART_TX")
QDEF(MP_QSTR_USB_PWR, (const byte*)"\x0b\x94\x07" "USB_PWR")
QDEF(MP_QSTR_ACCEL_CONFIG_ADDR, (const byte*)"\x74\xa1\x11" "ACCEL_CONFIG_ADDR")
QDEF(MP_QSTR_ACCEL_NORMAL_AVG4, (const byte*)"\x7a\xc6\x11" "ACCEL_NORMAL_AVG4")
QDEF(MP_QSTR_ACCEL_RANGE_16G, (const byte*)"\xf2\xd9\x0f" "ACCEL_RANGE_16G")
QDEF(MP_QSTR_ACCEL_RANGE_2G, (const byte*)"\x87\xf6\x0e" "ACCEL_RANGE_2G")
QDEF(MP_QSTR_ACCEL_RANGE_4G, (const byte*)"\xc1\xf7\x0e" "ACCEL_RANGE_4G")
QDEF(MP_QSTR_ACCEL_RANGE_8G, (const byte*)"\x4d\xf8\x0e" "ACCEL_RANGE_8G")
...
QDEF(MP_QSTR_ANY_MOT_INT, (const byte*)"\x16\x0b\x0b" "ANY_MOT_INT")
QDEF(MP_QSTR_ATTR_CCCD, (const byte*)"\xee\x2f\x09" "ATTR_CCCD")
QDEF(MP_QSTR_BMA42X, (const byte*)"\x75\xe2\x06" "BMA42X")
QDEF(MP_QSTR_BytesIO, (const byte*)"\x1a\xb7\x07" "BytesIO")
QDEF(MP_QSTR_CIC_AVG_MODE, (const byte*)"\x7f\x29\x0c" "CIC_AVG_MODE")
QDEF(MP_QSTR_CONTINUOUS_MODE, (const byte*)"\x74\x4d\x0f" "CONTINUOUS_MODE")
...
QDEF(MP_QSTR_DEG, (const byte*)"\x83\xba\x03" "DEG")
QDEF(MP_QSTR_DIS_ALL_AXIS, (const byte*)"\x59\x51\x0c" "DIS_ALL_AXIS")
QDEF(MP_QSTR_DOUBLE_TAP, (const byte*)"\xaa\x2f\x0a" "DOUBLE_TAP")
...
QDEF(MP_QSTR_EN_ALL_AXIS, (const byte*)"\x8c\x03\x0b" "EN_ALL_AXIS")
...
QDEF(MP_QSTR_FAHREN, (const byte*)"\xb3\x21\x06" "FAHREN")
...
QDEF(MP_QSTR_INTR1_MAP, (const byte*)"\x96\x7f\x09" "INTR1_MAP")
QDEF(MP_QSTR_INTR2_MAP, (const byte*)"\x95\x46\x09" "INTR2_MAP")
QDEF(MP_QSTR_IRQ_FALLING, (const byte*)"\x37\xc0\x0b" "IRQ_FALLING")
QDEF(MP_QSTR_IRQ_RISING, (const byte*)"\x78\xed\x0a" "IRQ_RISING")
QDEF(MP_QSTR_KELVIN, (const byte*)"\xd6\x3a\x06" "KELVIN")
...
QDEF(MP_QSTR_NO_MOT_INT, (const byte*)"\x21\xef\x0a" "NO_MOT_INT")
QDEF(MP_QSTR_NV_CONFIG_ADDR, (const byte*)"\x84\x0e\x0e" "NV_CONFIG_ADDR")
...
QDEF(MP_QSTR_OUTPUT_DATA_RATE_100HZ, (const byte*)"\x34\x4d\x16" "OUTPUT_DATA_RATE_100HZ")
QDEF(MP_QSTR_OUTPUT_DATA_RATE_50HZ, (const byte*)"\xc0\x2d\x15" "OUTPUT_DATA_RATE_50HZ")
QDEF(MP_QSTR_PERIODIC, (const byte*)"\x0a\x35\x08" "PERIODIC")
QDEF(MP_QSTR_POWER_CONF_ADDR, (const byte*)"\x0d\x45\x0f" "POWER_CONF_ADDR")
QDEF(MP_QSTR_POWER_CTRL_ADDR, (const byte*)"\xe0\x3e\x0f" "POWER_CTRL_ADDR")
...
QDEF(MP_QSTR_SCALE_TEMP, (const byte*)"\xce\xc9\x0a" "SCALE_TEMP")
QDEF(MP_QSTR_SECONDARY, (const byte*)"\xff\xad\x09" "SECONDARY")
QDEF(MP_QSTR_SINGLE_TAP, (const byte*)"\x65\x32\x0a" "SINGLE_TAP")
QDEF(MP_QSTR_SOFT_RESET, (const byte*)"\x01\xc6\x0a" "SOFT_RESET")
QDEF(MP_QSTR_SPI, (const byte*)"\xef\x11\x03" "SPI")
QDEF(MP_QSTR_STEP_ACT, (const byte*)"\xde\x3c\x08" "STEP_ACT")
QDEF(MP_QSTR_STEP_CNTR, (const byte*)"\x43\xb2\x09" "STEP_CNTR")
QDEF(MP_QSTR_STEP_CNTR_INT, (const byte*)"\xaf\xb3\x0d" "STEP_CNTR_INT")
...
QDEF(MP_QSTR_WRIST_WEAR, (const byte*)"\x10\x15\x0a" "WRIST_WEAR")
QDEF(MP_QSTR_X_AXIS_EN, (const byte*)"\x95\xb7\x09" "X_AXIS_EN")
QDEF(MP_QSTR_Y_AXIS_EN, (const byte*)"\xd4\x77\x09" "Y_AXIS_EN")
QDEF(MP_QSTR_Z_AXIS_EN, (const byte*)"\x97\xc5\x09" "Z_AXIS_EN")
...
QDEF(MP_QSTR_axes_en, (const byte*)"\x3e\xbe\x07" "axes_en")
QDEF(MP_QSTR_bandwidth, (const byte*)"\x0a\x92\x09" "bandwidth")
...
QDEF(MP_QSTR_bma42x, (const byte*)"\xf5\xd3\x06" "bma42x")
...
QDEF(MP_QSTR_enter_ota_dfu, (const byte*)"\x20\xfd\x0d" "enter_ota_dfu")
QDEF(MP_QSTR_enter_serial_dfu, (const byte*)"\x5a\x09\x10" "enter_serial_dfu")
...
QDEF(MP_QSTR_feature_enable, (const byte*)"\x0f\x2e\x0e" "feature_enable")
...
QDEF(MP_QSTR_get_offset_comp, (const byte*)"\x6f\x1f\x0f" "get_offset_comp")
QDEF(MP_QSTR_get_reg, (const byte*)"\x9c\x95\x07" "get_reg")
...
QDEF(MP_QSTR_map_interrupt, (const byte*)"\xc1\xdb\x0d" "map_interrupt")
...
QDEF(MP_QSTR_odr, (const byte*)"\x5c\x5d\x03" "odr")
...
QDEF(MP_QSTR_perf_mode, (const byte*)"\x38\xcb\x09" "perf_mode")
...
QDEF(MP_QSTR_read_accel_xyz, (const byte*)"\x44\xa7\x0e" "read_accel_xyz")
QDEF(MP_QSTR_read_int_status, (const byte*)"\x30\x2b\x0f" "read_int_status")
...
QDEF(MP_QSTR_set_accel_config, (const byte*)"\x25\x48\x10" "set_accel_config")
QDEF(MP_QSTR_set_accel_enable, (const byte*)"\xee\x74\x10" "set_accel_enable")
QDEF(MP_QSTR_set_any_mot_config, (const byte*)"\x72\xa2\x12" "set_any_mot_config")
QDEF(MP_QSTR_set_command_register, (const byte*)"\x69\xdb\x14" "set_command_register")
QDEF(MP_QSTR_set_no_mot_config, (const byte*)"\x25\xc4\x11" "set_no_mot_config")
QDEF(MP_QSTR_set_offset_comp, (const byte*)"\x7b\x8f\x0f" "set_offset_comp")
QDEF(MP_QSTR_set_reg, (const byte*)"\x88\x65\x07" "set_reg")
...
QDEF(MP_QSTR_starve_wdt, (const byte*)"\x5a\x0b\x0a" "starve_wdt")
...
QDEF(MP_QSTR_step_counter_output, (const byte*)"\x1c\x29\x13" "step_counter_output")
QDEF(MP_QSTR_step_counter_set_watermark, (const byte*)"\x5e\xf9\x1a" "step_counter_set_watermark")
QDEF(MP_QSTR_step_detector_enable, (const byte*)"\x6c\xaa\x14" "step_detector_enable")
...
QDEF(MP_QSTR_uart_connected, (const byte*)"\x57\x34\x0e" "uart_connected")
QDEF(MP_QSTR_uart_enabled, (const byte*)"\x4d\x67\x0c" "uart_enabled")
...
QDEF(MP_QSTR_write_config_file, (const byte*)"\x34\xd9\x11" "write_config_file")
